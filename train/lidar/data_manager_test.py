...
class DataManagerTest(unittest.TestCase):
    def sub_test_get_next_train_batch(self, data_manager, seq_length=20):
        ...
        self.assertEqual(target_ids.shape, (10, seq_length, 5))
        self.assertEqual(target_ids.dtype, "int8")

        self.assertEqual(target_distances.shape, (10, seq_length, 5))
        self.assertEqual(target_distances.dtype, "float32")
